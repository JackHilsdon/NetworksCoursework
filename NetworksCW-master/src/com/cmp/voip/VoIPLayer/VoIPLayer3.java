...
public class VoIPLayer3 implements IVoIPLayer {
    ...
    public boolean enableRepetition = false;
    ...
    public VoIPLayer3(ISecurityLayer securityLayer) {
...
//                            System.out.println("Missing " + (packetCount-i ));
    ...
    public void sendAudio(){
        ...
        datagramSocket = TransportHandler.getDatagramSocket3(true);
