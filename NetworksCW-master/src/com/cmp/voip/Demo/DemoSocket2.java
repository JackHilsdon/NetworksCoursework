...
import com.cmp.voip.VoIPLayer.VoIPLayer2;

public class DemoSocket2 {

    public static void main (String[] args){
        ISecurityLayer securityLayer = new BasicSecurityLayer();

        AudioSenderThread audioSenderThread = new AudioSenderThread(new VoIPLayer2(securityLayer));
        audioSenderThread.start();

        AudioRecieverThread audioRecieverThread = new AudioRecieverThread(new VoIPLayer2(securityLayer));
